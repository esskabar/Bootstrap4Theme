...
gulp.task('vendorsJs', function () {
    return streamqueue({objectMode: true},
        gulp.src('./src/js/vendor/jquery.scrollto.js'),
        gulp.src('./src/js/vendor/jquery.malihu.PageScroll2id.js'),
        gulp.src('./src/js/vendor/slick.min.js'),
        gulp.src('./src/js/vendor/jquery.viewportchecker.js'),
        gulp.src('./src/js/vendor/equal-height.js'),
        gulp.src('./src/js/vendor/bootstrap.min.js'),
        gulp.src('./src/js/vendor/browser-detect.js')
...
gulp.task('scriptsJs', function () {
    return streamqueue({objectMode: true},
        gulp.src('./src/js/custom/posts-page.js'),
        gulp.src('./src/js/custom/anchor-menu.js'),
